  ...
  return (
    <div className={`cct-theme ${themeClass} h-screen flex flex-col`}>
      ...
      >
        ...
        {/* Equator */}
        <line x1="0" y1={75/135*540} x2="960" y2={75/135*540} stroke="rgba(255,255,255,0.015)" strokeWidth="0.75"/>
        {/* Tropics */}
        <line x1="0" y1={(75-23.5)/135*540} x2="960" y2={(75-23.5)/135*540} stroke="rgba(249,115,22,0.018)" strokeWidth="0.75" strokeDasharray="4 6"/>
        <line x1="0" y1={(75+23.5)/135*540} x2="960" y2={(75+23.5)/135*540} stroke="rgba(249,115,22,0.018)" strokeWidth="0.75" strokeDasharray="4 6"/>
      </svg>
      <TopBar
        theme={theme}
