...
function Panel({
  ...
  return (
    <section
      className={`min-w-0 rounded-2xl border border-white/10 ${cardBg} p-5 shadow-[0_20px_45px_rgba(2,6,23,0.34)] ${className}`.trim()}
    >
      <div className="mb-4">
