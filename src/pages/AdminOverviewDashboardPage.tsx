...
function MetricPanel({ card }: { card: MetricCard }) {
  return (
    <div className="rounded-2xl border border-white/10 bg-slate-900/90 p-5 shadow-[0_20px_45px_rgba(2,6,23,0.34)] transition hover:-translate-y-0.5 hover:border-white/20">
...
function Panel({
  ...
  return (
    <section
      className={`min-w-0 rounded-2xl border border-white/10 bg-slate-900/90 p-5 shadow-[0_20px_45px_rgba(2,6,23,0.34)] ${className}`.trim()}
    >
      <div className="mb-4">
...
export default function AdminOverviewDashboardPage() {
  ...
  return (
    <div className="grid gap-6 xl:grid-cols-12">
      <section className="xl:col-span-12 rounded-[28px] border border-white/10 bg-[radial-gradient(circle_at_top_left,_rgba(59,130,246,0.16),_transparent_30%),linear-gradient(180deg,#0f172a_0%,#020617_100%)] p-6 shadow-[0_28px_60px_rgba(2,6,23,0.42)]">
