...
export default function AdminDashboardInsightsPage() {
  ...
  return (
    <div className="grid gap-6 xl:grid-cols-12">
      <section className="xl:col-span-12 rounded-[28px] border border-white/10 bg-[radial-gradient(circle_at_top_left,_rgba(34,197,94,0.12),_transparent_30%),radial-gradient(circle_at_bottom_right,_rgba(59,130,246,0.16),_transparent_30%),linear-gradient(180deg,#0f172a_0%,#020617_100%)] p-6 shadow-[0_28px_60px_rgba(2,6,23,0.42)]">
